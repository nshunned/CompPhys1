...
int main(int argc, char **argv) {
  ...
  TF1* myfunc = new TF1("myfunc", gaus2, xmin, xmax, npar);  // use this to fit the data and get results
  myfunc->SetParameters(1000,80,5,100,100,5);


  TString parName[npar] = {"A","m1","s1","B","m2","s2"};
