...
int quasirandom(int n = 40000, int skip = 0) {
   ...
   */
   ...
   TCanvas * cr = new TCanvas("cr","Pseudorandom sequence",dw/2,dw/3*2);
   cr->Divide(2,2);
   cr->cd(1);
   h0->ProjectionY()->Draw();
   cr->cd(2);
   ...
   TCanvas * cs = new TCanvas("cs","Sobol sequence",100,100,dw/2,dw/3*2);
   cs->Divide(2,2);
   cs->cd(1);
   h1->ProjectionY()->Draw();
   cs->cd(2);
   ...
   TCanvas * cn = new TCanvas("cn","Niederreiter sequence",150,100,dw/2,dw/3*2);
   cn->Divide(2,2);
   cn->cd(1);
   h2->ProjectionY()->Draw();
   cn->cd(2);
